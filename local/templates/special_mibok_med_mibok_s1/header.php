...
<html lang="ru">
    <head>
        ...
        <title>
            ...
            <?}?>
            <?$APPLICATION->IncludeComponent("bitrix:main.include", "", Array("AREA_FILE_SHOW"	=> "file", "PATH" => SITE_DIR."med_mibok_include/site_slogan.php", "MIBOK_SPECIAL_COMPARE" => "N"));?>
        </title>
    ...
    <body>
        ...
        <div id="content" class="<?=implode(' ', $arComponentsParams)?> <?if(COption::GetOptionString("mibok.med", "bootstrap_adaptive") == 'Y'):?>changebtstrp<?endif;?>">
					...
					<div class="container">
						<div class="row">
							<div class="col-xs-12 header-cookie">
								...
								<div class="">
									<a href="#" class="btn btn-default footer-cookie-btn"><?=GetMessage('COOKIE_OK')?></a>
								</div>
							</div>
            ...
            <header>
                <div class="bs-docs-header" role="banner">
                    <div class="container wcag">
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="template"><?$APPLICATION->IncludeComponent("bitrix:main.include", "", Array("AREA_FILE_SHOW"	=> "file", "PATH" => SITE_DIR."med_mibok_include/site_slogan.php", "MIBOK_SPECIAL_COMPARE" => "N"));?></h2>
                            </div>
                        </div>
                    </div>
                    <div class="container wcag">
		...
		"MIBOK_SPECIAL_KEY" => "c2a5873d989aaa8bed97a9ed43888a34"));?>                                                                                                                                    
                        <?$APPLICATION->IncludeComponent("bitrix:menu", ".default", array(
                                "ROOT_MENU_TYPE" => "medmibok",
                                "MENU_CACHE_TYPE" => "A",
                                "MENU_CACHE_TIME" => "0",
                                "MENU_CACHE_USE_GROUPS" => "Y",
	...
	false
            ...
            <div class="container bs-docs-container wcag">
                <div class="row">
                    <div class="col-md-12" role="main" id="main_content">
                        <?if($APPLICATION->GetCurDir() != '/' && COption::GetOptionString("mibok.med", "view_h1") == 'Y'){?>
                            <h1 class="page-header"><?$APPLICATION->ShowTitle(false);?></h1>
                        <?}?>   
                        <?$APPLICATION->IncludeComponent("bitrix:menu", ".default", Array("ALLOW_MULTI_SELECT" => "N",
		"CHILD_MENU_TYPE" => "left",
		"DELAY" => "N",
		"MAX_LEVEL" => "1",
		"MENU_CACHE_GET_VARS" => "",
		...
		"MIBOK_SPECIAL_KEY" => "fb5d73d4786967e872998ca9cf00e8a4"));?>                      
