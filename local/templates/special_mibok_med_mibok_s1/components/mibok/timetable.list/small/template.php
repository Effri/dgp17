...
<h2><?=($arParams['SIGN_HEAD'] ? $arParams['SIGN_HEAD'] : GetMessage('TIMETABLE_H1'))?> <?=GetMessage('PERIOD')?><?=date('d.m.Y', $arResult['INFO_DAY'][0]['tmp'])?> - <?=date('d.m.Y', $arResult['INFO_DAY'][count($arResult['INFO_DAY'])-1]['tmp'])?></h2>
