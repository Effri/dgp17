...
<div class="element-detail">    
    ...
    <?endif;?>
    <?if($arParams["DISPLAY_PICTURE"]!="N" && is_array($arResult["RESIZE"])):?>
            <img class="detail_picture" border="0" src="<?=$arResult["RESIZE"]["SRC"]?>" <?/*width="<?=$arResult["RESIZE"]["WIDTH"]?>" height="<?=$arResult["RESIZE"]["HEIGHT"]?>"*/?> alt="<?=$arResult["NAME"]?>"  title="<?=$arResult["NAME"]?>" />
    <?endif?>	
