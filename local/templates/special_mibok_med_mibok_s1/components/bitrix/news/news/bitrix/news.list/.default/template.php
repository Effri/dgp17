        ...
        <?foreach($arResult["ITEMS"] as $arItem):?>
            <div class="element-item">
                <div class="element-content" tabindex="0">
					...
					<?if(!empty($arItem["RESIZE"]['SRC'])):?>
					<img src="<?=$arItem["RESIZE"]['SRC']?>" title="<?=GetMessage("MPHOTO")?><?=$arItem['DISPLAY_PROPERTIES']['SURNAME']['VALUE']?> <?=$arItem["NAME"]?> <?=$arItem['DISPLAY_PROPERTIES']['LASTNAME']['VALUE']?>"><br>
					<?endif;?>
