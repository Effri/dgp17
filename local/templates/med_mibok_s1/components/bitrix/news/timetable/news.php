...
//if(empty($GLOBALS[$arParams["FILTER_NAME"]]['PROPERTY']['?TYPE_SPORT']) && !empty($GLOBALS[DEFAULT_TYPE_SPORT]))
//    $GLOBALS[$arParams["FILTER_NAME"]]['PROPERTY']['?TYPE_SPORT'] = $GLOBALS[DEFAULT_TYPE_SPORT];
if(!empty($GLOBALS[$arParams["FILTER_NAME"]]['PROPERTY']['?TYPE_SPORT'])):
?>


<?
    //получаем значения для выборки периода
 ...
 //MibokMed::p($GLOBALS[$arParams["FILTER_NAME"]]);
?>
...
<?else:?>
    <div class="clearfix timing">
            ...
            <p class="bg-warning bg-label"><?=GetMessage('TYPE_SPORT_NO')?></p>
            </div>
        </div>
<?endif;?>
</div>