...
<div class="search-page">
    ...
    <div class="l-contact-form search">
	<form action="" method="get">
        ...
        <div class="search-input">
            <label >
                ...
                <?else:?>
                    <input type="text" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>" placeholder="<?=GetMessage('SEARCH_VALUE')?>"/>
                <?endif;?>
            </label>
        </div>
        ...
        <div class="search-submit">
            <div>
                <input class="search-button btn btn-blue" type="submit" value="<?echo GetMessage("CT_BSP_GO")?>" />
            </div>
        </div>
