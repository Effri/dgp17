                            ...
                            <?foreach($arResult["ITEMS"] as $arItem):
                                ...
                                <?if(!empty($arItem["PREVIEW_PICTURE"]["SRC"]) || !empty($arItem['DISPLAY_PROPERTIES']['ICON']['VALUE'])):?>
                                    <div class="swiper-slide" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
                                        <a href="<?=$arItem["PROPERTIES"]['LINK']['VALUE'] ? $arItem["PROPERTIES"]['LINK']['VALUE'] : $arItem["DETAIL_PAGE_URL"]?>" class="slider-direction-img-wrapper sport-img-header" title="<?=$arItem["NAME"]?>">
                                        ...
                                        <div class="slider-direction-title sport-title-header"><?=$arItem["NAME"]?></div>
                                    </div>
                                <?endif;?>
                            <?endforeach;?> 
                        </div>
