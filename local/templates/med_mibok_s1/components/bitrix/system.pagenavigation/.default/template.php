...
<?if($arResult["bDescPageNumbering"] === true):?>
	...
	<?if ($arResult["NavPageNomer"] < $arResult["NavPageCount"]):?>
		<?if($arResult["bSavePage"]):?>
			<li class="pagination-prev"><a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>"><span><?echo GetMessage("round_nav_back")?></span></a></li>
		...
		<?else:?>
			<?if (($arResult["NavPageNomer"]+1) == $arResult["NavPageCount"]):?>
				<li class="pagination-prev"><a href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"><span><?echo GetMessage("round_nav_back")?></span></a></li>
			<?else:?>
				<li class="pagination-prev"><a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]+1)?>"><span><?echo GetMessage("round_nav_back")?></span></a></li>
			<?endif?>
		...
		<?endif?>
	<?else:?>
			<li class="pagination-prev"><span><?echo GetMessage("round_nav_back")?></span></li>
	...
	?>
		...
		<?if ($arResult["nStartPage"] == $arResult["NavPageNomer"]):?>
			<li class="pagination-current"><span><?=$NavRecordGroupPrint?></span></li>
		<?else:?>
	...
	<?if ($arResult["NavPageNomer"] > 1):?>
		...
		<?endif?>
			<li class="pagination-next"><a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=($arResult["NavPageNomer"]-1)?>"><span><?echo GetMessage("round_nav_forward")?></span></a></li>
	<?else:?>
		<?if($arResult["NavPageCount"] > 1):?>
			<li class="pagination-current"><span><?=$arResult["NavPageCount"]?></span></li>
		<?endif?>
			<li class="pagination-next"><span><?echo GetMessage("round_nav_forward")?></span></li>
	<?endif?>
...
<?else:?>
	...
	?>
		<?if ($arResult["nStartPage"] == $arResult["NavPageNomer"]):?>
			<li class="pagination-current"><span><?=$arResult["nStartPage"]?></span></li>
		<?else:?>
